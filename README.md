...
---
🪦 Я вёл телеграм-канал [Winterview](https://t.me/pavel_frankov) про развитие карьеры фронтенд-разработчика. Во время активной фазы там был бот, для которого я разработал схему простого создания интерактивных рассылок. Теперь это просто база знаний, а я не захотел рассказывать одно и то же, но с разных ракурсов.  
